...
public class Admin107BrowseDeleteFacilities {
    @Rule
    ...
    @Test
    public void adminBrowseDeleteFacilities() throws InterruptedException {
        ...
        intended(hasComponent(FacilityActivity.class.getName()));
