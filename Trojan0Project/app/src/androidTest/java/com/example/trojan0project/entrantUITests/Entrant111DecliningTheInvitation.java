...
public class Entrant111DecliningTheInvitation {
    @Rule
    ...
    @Test
    public void entrantCanDeclineEvent() throws InterruptedException {
        ...
        onView(withId(R.id.buttonDecline)).perform(click());
