...
public class EventDetailsActivityOrganizer extends AppCompatActivity {
    ...
    private Button changePosterButton, viewPeopleButton, cancelledEntrantsButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cancelledEntrantsButton = findViewById(R.id.buttonCancelledEntrants); // Initialize the button
        ...
        // Set up Cancelled Entrants button click listener
        cancelledEntrantsButton.setOnClickListener(v -> {
            Intent intent = new Intent(EventDetailsActivityOrganizer.this, CancelledEntrantsActivity.class);
